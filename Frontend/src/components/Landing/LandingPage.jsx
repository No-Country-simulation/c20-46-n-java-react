                ...
                <div className="relative min-h-screen flex flex-col justify-center">
                    ...
                    <div className="relative z-10 text-white max-w-2xl px-6 py-8 bg-black bg-opacity-50 rounded-lg ml-8 mr-8 md:ml-16 lg:ml-24">
                        ...
                        <p className="mb-6 text-lg md:text-xl">
                            MindMates es una plataforma diseñada para ofrecer apoyo emocional a personas que lo necesitan, creando un entorno 
                            seguro y accesible donde se puedan compartir pensamientos, sentimientos, y recibir la ayuda necesaria de
                            compañeros de escucha capacitados.
                        </p>
